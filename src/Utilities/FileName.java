...
public class FileName {
    ...
    public static final String FileSamplePublishers = "data/xml_publishers.xml";

    public static final String FileSamplePersons = "data/xml_persons.xml";

    public static final String FileSampleStoryArcs = "data/xml_storyarcs.xml";
    ...
    how to add value to XML database
